...
var _videoPlayer = require("./js/_video-player");
var _bodyHandler = require("./js/_body-handler");

},{"./js/_video-player":"jZsx6","./js/_body-handler":"gqbfK"}],"jZsx6":[function(require,module,exports) {
...
},{}],"gqbfK":[function(require,module,exports) {
const height = document.querySelector("body > div.body-wrapper").getBoundingClientRect().height;
document.body.setAttribute("style", `height:${height - 900}px`);
console.log(height);

},{}]},["7nZVA","8lqZg"], "8lqZg", "parcelRequirec907")
